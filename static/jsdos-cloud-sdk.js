...
(function (CloudSDK) {
  ...
  async function pushToStorage(token, fileName, payload) {
    ...
    const presign = await (
      await fetch(presignPut + "?path=" + encodeURIComponent(fileName) + "&token=" + token)
    ).json();
    if (!presign.success) {
  ...
  async function pullFromStorage(token, fileName) {
    ...
    if (profile && profile.email) {
      const response = await fetch(storageEndpoint + "/" + profile.email + "/" + encodeURIComponent(fileName), {
        cache: "no-cache"
      });
...
(function (CloudSDKUI) {
    ...
    return {
      ...
      bind: () => {
        if (v8Key === null) {
          ...
          CloudSDK.resolveToken(v8Key)
            .then((token) => {
              var _a;
              premium =
                (_a = token === null || token === void 0 ? void 0 : token.premium) !== null && _a !== void 0
                  ? _a
                  : false;
              state = "key";
            })
      ...
      if (value.length === 5) {
        ...
        CloudSDK.resolveToken(value)
          .then((token) => {
            ...
            premium =
              (_a = token === null || token === void 0 ? void 0 : token.premium) !== null && _a !== void 0 ? _a : false;
          })
          .catch(() => {
            state = "nokey";
          });
  ...
  function Key() {
    ...
    return {
      ...
      bind: (root) => {
        var _a;
        (_a = root.querySelector(".cloud-saves-clear")) === null || _a === void 0
          ? void 0
          : _a.addEventListener("click", reset);
      },
      unbind: (root) => {
        var _a;
        (_a = root.querySelector(".cloud-saves-clear")) === null || _a === void 0
          ? void 0
          : _a.removeEventListener("click", reset);
      }
    };
  }
  function Hidden() {
